          ...
          <Modal show={true} onHide={this.props.toggleEditModal}>
            ...
            <Modal.Body>
              <Form>
                ...
                <Button variant="primary" onClick={this.updateAmount}>
                  Done
                </Button>
                <Button
                  className="goBack"
                  variant="secondary"
                  onClick={this.amountEdit}
                >
                  Cancel
                </Button>
              </Form>
        ...
        <Container>
          <Modal show={true} onHide={this.props.toggleEditModal}>
            ...
            <Modal.Body>
              <Form>
                <Form.Group className="mb-3">
                  <Form.Label htmlFor="amountEdit">
                    Are you sure you want to delete this stream?{" "}
                  </Form.Label>
                  <p>
                    <Button variant="danger" onClick={this.handleDeleteStream}>
                      Yes
                    </Button>
                    <Button
                      className="goBack"
                      variant="secondary"
                      onClick={this.deletingStream}
                    >
                      No
                    </Button>
                  </p>
          ...
          <Modal show={true} onHide={this.props.toggleEditModal}>
            ...
            <Modal.Body>
              ...
              <p>
                ...
                {`$${this.state.placeholderAmount}/month`}{" "}
                <Button size="sm" variant="secondary" onClick={this.amountEdit}>
                  Edit
                </Button>
              </p>
              <Button size="sm" variant="danger" onClick={this.deletingStream}>
                Delete
              </Button>
            </Modal.Body>
            <Modal.Footer>
